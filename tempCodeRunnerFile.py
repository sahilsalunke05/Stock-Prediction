...
def index():
    #  Define all variables upfront (default values)
    stock_name = None
    sector = None
    website = "#"
    ceo = "N/A"
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            print("⚠️ Error fetching company info:", e)


        print("Company Info:", stock_name, sector, website)
        ...
        print("Shape of downloaded df:", df.shape)
        print("Data columns:", df.columns)
        print("Head of df:\n", df.head())
        print("Shape of data_training:", data_training.shape)
